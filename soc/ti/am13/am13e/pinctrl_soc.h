...
#include <zephyr/dt-bindings/pinctrl/am13e-pinctrl.h>
...
#define AM13E_GPIO_OPEN_DRAIN_OUTPUT  (25)
...
#define AM13E_PIN_CONTROL_IOMUX_INIT(node_id)                                                      \
	((DT_PROP(node_id, bias_pull_up) << AM13E_GPIO_RESISTOR_PULL_UP) |                         \
	 (DT_PROP(node_id, bias_pull_down) << AM13E_GPIO_RESISTOR_PULL_DOWN) |                     \
	 (DT_PROP(node_id, drive_open_drain) << AM13E_GPIO_OPEN_DRAIN_OUTPUT) |                    \
